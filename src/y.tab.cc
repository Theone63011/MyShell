...
#define NOTOKEN 259
#define NEWLINE 260
#define GREATGREATAMPERSAND 261
...
{
       0,    51,    51,    55,    56,    60,    64,    65,    69,    70,
      74,    81,    82,    86,    87,    91,   104,   113,   116,   121,
     129,   135,   139,   146,   151
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "NEWLINE",
  "GREATGREATAMPERSAND", "GREATGREAT", "TWOGREAT", "GREATAMPERSAND",
  "GREAT", "LESS", "PIPE", "AMPERSAND", "$accept", "goal", "commands",
  "command", "pipe_list", "command_and_args", "iomodifier_list",
  "argument_list", "argument", "command_word", "background_opt",
  "iomodifier", YY_NULLPTR
};
#endif
...
static const yytype_uint8 yydefact[] =
{
       ...
       7,     1,     4,     0,    18,    10,     8,     0,     0,     0,
       0,     0,     0,    17,     0,    11,    15,    13,    19,    20,
      21,    22,    23,    24,     5
};
...
{
       0,     1,     3,     5,    15,    16,    17,    18,    19,    23,
       5,     0,    17,    12,    20,    21,    19,     6,     7,     8,
       9,    10,    11,    13,    24,    25,     3,    22,     3,     3,
       3,     3,     3,     3,     5
};
...
#line 91 "shell.y" /* yacc.c:1646  */
    ...
    if(strcmp(Command::_currentSimpleCommand->_arguments[0]->c_str(), "echo") == 0 
      && strchr((yyvsp[0].cpp_string)->c_str(), '?')) {
        Command::_currentSimpleCommand->insertArgument( (yyvsp[0].cpp_string) );
    }
    else {
      expandWildCardsIfNecessary(const_cast<char*>((yyvsp[0].cpp_string)->c_str()));
    }
  }
